...
import { Archive, CircleDollarSign, Clipboard, Layout, LucideIcon, Menu, Sliders, User } from "lucide-react"
...
const SidebarLink = ({ href, icon: Icon, label, isCollapsed }: SidebarLinkProps) => {
    // grab path of url where we're at
    ...
    return (
        <div className={sidebarClassNames}>
            ...
            <div className="flex-grow mt-8">
                ...
                <SidebarLink href="/prdoucts" icon={Clipboard} label="Products" isCollapsed={isSidebarCollapsed} />
                <SidebarLink href="/users" icon={User} label="Users" isCollapsed={isSidebarCollapsed} />
                <SidebarLink href="/settings" icon={Sliders} label="Settings" isCollapsed={isSidebarCollapsed} />
                <SidebarLink
                    href="/expenses"
